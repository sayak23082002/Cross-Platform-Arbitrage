...
contract FlashLoan {
    ...
    function uniswapV2Call(
        ...
        console.log("Before any transaction, the value od USDC: ", loanAmount);
        ...
        console.log("After 1st trade, the amount of LINK token: ", trade1Coin);
        ...
        uint256 trade2Coin = placeTrade(
         ...
         console.log("After 2nd trade, the amount of USDC token: ", trade2Coin);
